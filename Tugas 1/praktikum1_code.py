...
print('Nilai Dingin =', value_cool)
print('Nilai Hangat =', value_warm)
print('Nilai Panas =', value_hot)
print('')
print('Hasil derajat keanggotaan pada setiap variabel Linguistik "Cloud Cover"' )
print('Nilai Cerah =', value_sunny)
print('Nilai Berawan =', value_partlycloudy)
print('Nilai Menddung =', value_overcast)
...
def fungsiinferensipelan(value_temp, value_cloud):
    if value_temp!=0 :
       if value_cloud!=0:
...
def fungsiinferensicepat(value_temp, value_cloud):
    if value_temp!=0 :
       if value_cloud!=0:
           hasil_fungsi = min(value_temp, value_cloud)
...
fungsiinferensipelan(value_freezing,value_sunny)
fungsiinferensipelan(value_freezing,value_partlycloudy)
fungsiinferensipelan(value_freezing,value_overcast)
fungsiinferensipelan(value_cool,value_sunny)
fungsiinferensipelan(value_cool,value_partlycloudy)
fungsiinferensipelan(value_cool,value_overcast)
fungsiinferensicepat(value_warm,value_sunny)
fungsiinferensicepat(value_warm,value_partlycloudy)
fungsiinferensicepat(value_warm,value_overcast)
fungsiinferensicepat(value_hot,value_sunny)
fungsiinferensicepat(value_hot,value_partlycloudy)
fungsiinferensicepat(value_hot,value_overcast)
